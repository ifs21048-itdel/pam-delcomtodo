package com.ifs21048.delcomtodo.presentation.main
...
import com.ifs21048.delcomtodo.R
import com.ifs21048.delcomtodo.adapter.TodosAdapter
import com.ifs21048.delcomtodo.data.remote.MyResult
import com.ifs21048.delcomtodo.data.remote.response.DelcomTodosResponse
import com.ifs21048.delcomtodo.data.remote.response.TodosItemResponse
import com.ifs21048.delcomtodo.databinding.ActivityMainBinding
import com.ifs21048.delcomtodo.helper.Utils.Companion.observeOnce
import com.ifs21048.delcomtodo.presentation.ViewModelFactory
import com.ifs21048.delcomtodo.presentation.login.LoginActivity
import com.ifs21048.delcomtodo.presentation.profile.ProfileActivity
import com.ifs21048.delcomtodo.presentation.todo.TodoDetailActivity
import com.ifs21048.delcomtodo.presentation.todo.TodoManageActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private val launcher = registerForActivityResult(
        ...
        if (result.resultCode == TodoManageActivity.RESULT_CODE || result.resultCode == TodoDetailActivity.RESULT_CODE) {
            recreate()
        }
        result.data?.let {
